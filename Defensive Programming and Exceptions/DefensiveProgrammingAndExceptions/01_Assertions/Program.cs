...
class AssertionsHomework
{
    public static void SelectionSort<T>(T[] arr) where T : IComparable<T>
    {
        ...
        Debug.Assert(arr != null, "Array is not defined");
    ...
    {
        Debug.Assert(arr != null, "Array is not defined");
        Debug.Assert(startIndex >= 0, "Index is negative value");
        Debug.Assert(endIndex < arr.Length, "Index is outside boundaries of the array");
